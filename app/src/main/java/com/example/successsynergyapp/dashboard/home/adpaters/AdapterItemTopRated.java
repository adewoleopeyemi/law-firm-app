...
public class AdapterItemTopRated extends RecyclerView.Adapter<AdapterItemTopRated.Holder>{
    Context context;
    ArrayList<ModelServiceProvider> users;

    public AdapterItemTopRated(Context context, ArrayList<ModelServiceProvider> users) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.layout_item_home_top_rated, parent, false);
        return new Holder(v);
    }
